...
let downloadClicks = (() => {
    var _ref = asyncGenerator.wrap(function* () {
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;

        try {
            for (var _iterator = asyncIterator(listenTo(document.documentElement, "click")), _step, _value; _step = yield asyncGenerator.await(_iterator.next()), _iteratorNormalCompletion = _step.done, _value = yield asyncGenerator.await(_step.value), !_iteratorNormalCompletion; _iteratorNormalCompletion = true) {
                const event = _value;
...
let downloadAll = (() => {
    var _ref2 = asyncToGenerator(function* () {
        ...
        try {
            for (var _iterator2 = asyncIterator(downloadClicks()), _step2, _value2; _step2 = yield _iterator2.next(), _iteratorNormalCompletion2 = _step2.done, _value2 = yield _step2.value, !_iteratorNormalCompletion2; _iteratorNormalCompletion2 = true) {
                const url = _value2;
